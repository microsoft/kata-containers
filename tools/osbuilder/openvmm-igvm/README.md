...
The image builder writes dm-verity metadata to `root_hash_*.txt`. Rootfs mode
requires this metadata and rejects a command line that cannot be updated to
enable dm-verity. Build and run the working agent variant:
