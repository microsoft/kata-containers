...
mount_source_allows(p_mount, i_mount, bundle_id, sandbox_id) {
    ...
    # The caller of this function already verified p_mount.type_ == i_mount.type_.
    #
...
mount_source_allows(p_mount, i_mount, bundle_id, sandbox_id) {
    print("mount_source_allows 2: i_mount =", i_mount, "p_mount =", p_mount)

    # The caller of this function already verified p_mount.type_ == i_mount.type_.
    #
    # DMFIX - need additional testing.
    p_mount.source == "$(guest-local-file)"
