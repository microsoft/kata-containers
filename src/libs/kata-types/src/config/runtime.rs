...
pub const DEFAULT_SNAPSHOT_ROOT: &str = "/var/lib/kata-containers/snapshots";
...
pub struct Runtime {
    ...
    /// Default workload memory added to the sandbox when static resource management
    /// is enabled and no explicit workload memory limit was provided.
    #[serde(default)]
