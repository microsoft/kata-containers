...
impl_agent!(
    ...
    start_container | crate::StartContainerRequest | crate::Empty | None,
    ...
    stats_container | crate::StatsContainerRequest | crate::StatsContainerResponse | None,
    ...
    list_interfaces | crate::ListInterfacesRequest | crate::Interfaces | None,
    list_routes | crate::Empty | crate::Routes | None,
    create_sandbox | crate::CreateSandboxRequest | crate::Empty | None,
    destroy_sandbox | crate::DestroySandboxRequest | crate::Empty | None,
    copy_file | crate::CopyFileRequest | crate::Empty | None,
    get_oom_event | crate::GetOOMEventRequest | crate::OomEventResponse | Some(0),
