...
impl_agent!(
    ...
    copy_watchable_volume_directory | crate::CopyWatchableVolumeDirectoryRequest | crate::Empty | None,
    copy_watchable_volume_file | crate::CopyWatchableVolumeFileRequest | crate::Empty | None,
    create_watchable_volume_file_symlink_by_volume | crate::CreateWatchableVolumeFileSymlinkByVolumeRequest | crate::Empty | None,
    create_watchable_volume_data_symlink_by_volume | crate::CreateWatchableVolumeDataSymlinkByVolumeRequest | crate::Empty | None,
