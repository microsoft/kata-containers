...
type qemuArch interface {
	...
	appendProtectionDevice(devices []govmmQemu.Device, firmware, firmwareVolume string, configHash string) ([]govmmQemu.Device, string, error)
...
// append protection device
func (q *qemuArchBase) appendProtectionDevice(devices []govmmQemu.Device, firmware, firmwareVolume string, configHash string) ([]govmmQemu.Device, string, error) {
